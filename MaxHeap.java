...
public class MaxHeap<T> {
    ...
    /**
     * Crearea Heap-ului si copierea elementelor din array.
     */
    ...
    /**
     * Crearea Heap-ului si copierea listei.
     */
    ...
    /**
     * Verficarea conditiilor de heap.
     * <p>
     * Se pleaca de la faptul ca lchild si rchild sunt heap
     * si se doreste ca si root sa indeplineasca conditiile de heap.
     */
    ...
    /**
     * Formula pentru obtinerea intexului corespunzator parintelui.
     */
    ...
    /**
     * Formula pentru obtinerea intexului corespunzator copilului stang.
     */
    ...
    /**
     * Formula pentru obtinerea intexului corespunzator copilului drept.
     */
    ...
    public void insert(T el) {
        heap.add(el);
        int elIndex = heap.size() - 1; // ultimul element
    ...
    public void deleteMaxElement() {
        ...
        swap(heap, 0, heap.size() - 1); //schimba primul cu ultimul element [1 2 3] -> [3 2 1]
        heap.remove(heap.size() - 1); //sterge ultimul element (aici: 1) - [3 2]
    ...
    /**
     * Obtinerea unei copii a heap-ului (pentru teste).
     */
